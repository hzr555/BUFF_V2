...
int main(int argc, char* argv[]) {
	...
	// capture = cv::VideoCapture("/home/nuc/buff_red.avi");
    capture = cv::VideoCapture("/home/nuc/video_variable_spd.mp4");
    // capture = cv::VideoCapture(/home/nuc/video_static_spd.avi");
