...
cv::VideoWriter video = cv::VideoWriter(video_path , cv::VideoWriter::fourcc('M', 'J', 'P', 'G'), 30, cv::Size(800, 600));
// cv::VideoWriter video = cv::VideoWriter(video_path , CV_FOURCC('M', 'J', 'P', 'G'), 30, cv::Size(800, 600));
