...
class sagitari_img_debug {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new sagitari_img_debug(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new sagitari_img_debug(null);
...
module.exports = sagitari_img_debug;
